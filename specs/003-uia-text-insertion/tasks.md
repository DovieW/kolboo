...
**Input**: Design documents from `specs/003-uia-text-insertion/`

- Required: `specs/003-uia-text-insertion/spec.md`, `specs/003-uia-text-insertion/plan.md`
- Supporting: `specs/003-uia-text-insertion/research.md`, `specs/003-uia-text-insertion/data-model.md`, `specs/003-uia-text-insertion/contracts/tauri-openapi.yaml`, `specs/003-uia-text-insertion/quickstart.md`
...
- [x] T001 Add `specs/003-uia-text-insertion/tasks.md` from template structure (this file)
...
- [x] T038 Document the new setting and manual test steps in `specs/003-uia-text-insertion/quickstart.md`
- [x] T039 Add a brief developer note on known UIA limitations (Chromium/Electron) in `specs/003-uia-text-insertion/research.md`
...
- [x] T044 [US1] Verify insertion succeeds in Notepad and focus-change aborts to safe fallback (clipboard + toast) in `specs/003-uia-text-insertion/quickstart.md`
- [ ] T045 [US2] Verify selection/surrounding context capture works without clipboard changes when fallback is OFF in `specs/003-uia-text-insertion/quickstart.md`
- [ ] T046 [US2] Verify clipboard context is only included when explicitly enabled (not as a highlighted-text fallback) in `specs/003-uia-text-insertion/quickstart.md`
- [ ] T047 [US3] Verify password/disabled/read-only fields block capture/insert and trigger safe fallback in `specs/003-uia-text-insertion/quickstart.md`
