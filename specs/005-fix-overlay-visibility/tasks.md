...
**Input**: Design documents from `specs/005-fix-overlay-visibility/`  
...
- [x] T003 [P] Inventory overlay hide/show paths and stale-timer risks in `app/src/overlay/RecordingControl.tsx` and `app/src/overlay/useOverlayHideRequested.ts`, then update notes in `specs/005-fix-overlay-visibility/research.md`
...
- [ ] T012 [US1] Validate MVP manually using `specs/005-fix-overlay-visibility/quickstart.md` (sections “Basic show/hide” + focus check) and update `specs/005-fix-overlay-visibility/quickstart.md` if any steps/logs changed
- [x] T012 [US1] Validate MVP manually using `specs/005-fix-overlay-visibility/quickstart.md` (sections “Basic show/hide” + focus check) and update `specs/005-fix-overlay-visibility/quickstart.md` if any steps/logs changed
...
- [ ] T014 [US2] Validate sleep/wake scenario using `specs/005-fix-overlay-visibility/quickstart.md` (section “Sleep/wake recovery”) and record any tweaks back into `specs/005-fix-overlay-visibility/quickstart.md`
...
- [ ] T016 [US3] Validate monitor/DPI change scenarios using `specs/005-fix-overlay-visibility/quickstart.md` (section “Monitor/DPI change resilience”) and update `specs/005-fix-overlay-visibility/quickstart.md` if needed
...
- [ ] T021 Re-run the full manual verification checklist and finalize expected log snippets in `specs/005-fix-overlay-visibility/quickstart.md`
...
4. **STOP and VALIDATE** using `specs/005-fix-overlay-visibility/quickstart.md`
