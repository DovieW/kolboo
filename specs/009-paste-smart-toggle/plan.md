...
**Branch**: `009-paste-smart-toggle` | **Date**: 2026-02-01 | **Spec**: `specs/009-paste-smart-toggle/spec.md`
**Input**: Feature specification from `/specs/009-paste-smart-toggle/spec.md`
...
Completed in `specs/009-paste-smart-toggle/research.md`.

## Phase 1: Design & Contracts

- Data model: `specs/009-paste-smart-toggle/data-model.md`
- API contract: `specs/009-paste-smart-toggle/contracts/settings.openapi.yaml`
- Quickstart: `specs/009-paste-smart-toggle/quickstart.md`
