...
**Branch**: `001-profile-disable-toggle` | **Date**: 2026-01-25 | **Spec**: `specs/001-profile-disable-toggle/spec.md`
**Input**: Feature specification from `/specs/001-profile-disable-toggle/spec.md`
...
```text
specs/001-profile-disable-toggle/
...
Research output: `specs/001-profile-disable-toggle/research.md`

## Phase 1: Design & Contracts

Design outputs:

- Data model: `specs/001-profile-disable-toggle/data-model.md`
- Contracts: `specs/001-profile-disable-toggle/contracts/*`
- Quickstart: `specs/001-profile-disable-toggle/quickstart.md`
