...
**Input**: Design documents from `specs/001-profile-disable-toggle/`

- `specs/001-profile-disable-toggle/spec.md`
- `specs/001-profile-disable-toggle/plan.md`
- `specs/001-profile-disable-toggle/research.md`
- `specs/001-profile-disable-toggle/data-model.md`
- `specs/001-profile-disable-toggle/contracts/`
- `specs/001-profile-disable-toggle/quickstart.md`
...
- [ ] T001 Confirm feature docs are present under `specs/001-profile-disable-toggle/` (spec.md, plan.md, research.md, data-model.md, contracts/, quickstart.md)
...
- [x] T001 Confirm feature docs are present under `specs/001-profile-disable-toggle/` (spec.md, plan.md, research.md, data-model.md, contracts/, quickstart.md)
...
**Independent Test**: Using `specs/001-profile-disable-toggle/quickstart.md`, disable one profile and confirm it never becomes active and persists across restart.
...
**Independent Test**: Disable then re-enable a profile and confirm it can become active again (per `specs/001-profile-disable-toggle/quickstart.md`).
...
- [x] T020 [P] Reconcile docs with final behavior in `specs/001-profile-disable-toggle/quickstart.md` and `specs/001-profile-disable-toggle/contracts/*.md`
