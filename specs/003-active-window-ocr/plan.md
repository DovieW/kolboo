...
**Branch**: `003-active-window-ocr` | **Date**: 2026-01-28 | **Spec**: `specs/003-active-window-ocr/spec.md`
**Input**: Feature specification from `specs/003-active-window-ocr/spec.md`
