...
**Input**: Design documents from `specs/004-active-window-ocr/`
...
- [x] T017 [P] Update overlay polling payload to include `session_id` + stable OCR job fields in `app/src-tauri/src/commands/ocr.rs` and `app/src/lib/tauri/commands.ts` (follow `specs/004-active-window-ocr/contracts/ocr-internal.contract.md`)
...
- [x] T045 [P] Update quickstart steps + debug tips in `specs/004-active-window-ocr/quickstart.md`
- [x] T046 [P] Validate OCR provider HTTP contract assumptions in `specs/004-active-window-ocr/contracts/ocr-service.openapi.yaml`
- [x] T047 [P] Confirm internal contract matches implementations in `specs/004-active-window-ocr/contracts/ocr-internal.contract.md`
