...
**Branch**: `001-hotkey-shortcut-cards` | **Date**: 2026-02-01 | **Spec**: /specs/001-hotkey-shortcut-cards/spec.md
**Input**: Feature specification from `/specs/001-hotkey-shortcut-cards/spec.md`
...
```text
specs/001-hotkey-shortcut-cards/
...
**Structure Decision**: UI changes will live under `app/src/**` and any settings normalization or backend updates will live under `app/src-tauri/src/**`. Feature documentation is isolated in `specs/001-hotkey-shortcut-cards/`.
