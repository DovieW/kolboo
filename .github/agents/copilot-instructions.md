...
- Rust (Tauri v2 backend) + TypeScript (strict) UI + Tauri, tauri-plugin-cli, React/Vite (001-backend-cli)
- Tauri store (`settings.json`) for persisted settings and profiles (001-backend-cli)
...
## Recent Changes
- 001-backend-cli: Added Rust (Tauri v2 backend) + TypeScript (strict) UI + Tauri, tauri-plugin-cli, React/Vite
- 001-hotkey-shortcut-cards: Added TypeScript (strict) + Rust (Tauri) + React/Vite, Tauri, TanStack Query
